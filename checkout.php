...
if (strlen($_SESSION['jsmsuid'] == 0)) {
	...
	if (isset($_POST['placeorder'])) {
		...
		if ($result) {
			...
			// header("Location: ./stripePayGetway/index.php");
			header("Location: ./stripePayGetway/index.php?orderno=$orderno&amount=$grandtotal");
            exit();
		}
	}
}   ?>
...
<head>
	<meta charset="utf-8">
	<title>Jewellery Shop Management System || Checkout <?php  
