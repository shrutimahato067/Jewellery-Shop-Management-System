            ...
            <div class="carousel-inner rounded-1">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="">You deserve to be beauty</h5>
                        <p class="text-light">Diamond necklace</p>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="">Make your life better</h5>
                        <p class="text-light">Engagement ring</p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <section class="quick-links">
                <div class="last-products">
                    ...
                    ?>
                        <article style="background-image: url(images/18.jpg); width: 360px !important; margin-top:1%; border-radius:.25rem;" class="category-card">
                            <a href="subcategory.php?scid=<?php echo $row['id']; ?>&&catname=<?php echo $row['categoryName']; ?>" class="table">
                                <div class="cell">
                                    <?php
                                    if ($row['categoryName'] == 'Mangalsutra' || $row['categoryName'] == "Chain" || $row['categoryName'] == 'Necklace' || $row['categoryName'] == 'Nose pin' || $row['categoryName'] == 'Toe Ring') { ?>
                                        <div class="upcoming-prod position-relative">
                                            <p class="upcoming-txt position-absolute text-dark p-0" style="top: -100%; right:0%;">
                                                <span>Upcoming ...</span>
                                            </p>
                                            <div class="text">
